...
namespace ArgeBackend.Services.Infrastructure.Services
{
    public interface IApplicationForSessionService
    {
        Task<IEnumerable<ApplicationForSessionDTO>> GetList(int? userId, int? sessionId, DateTime? date, bool includeDeleted = false);
